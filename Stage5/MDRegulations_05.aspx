...
　                       <td width="20%"><a href="./管理细则（6）/先进班集体评选细则.WPS"><img src="./icon_download.png"><br><br>先进班集体评选细则</a></td>
                        <td width="20%"><a href="./管理细则（6）/创建文明班级实施细则.wps"><img src="./icon_download.png"><br><br>创建文明班级实施细则</a></td>
                        <td width="20%"><a href="./管理细则（6）/班主任工作细则.WPS"><img src="./icon_download.png"><br><br>班主任工作细则</a></td>
                        <td width="20%"><a href="./管理细则（6）/班主任与副班主任分工细则.WPS"><img src="./icon_download.png"><br><br>班主任与副班主任分工细则</a></td>
                        <td width="20%"><a href="./管理细则（6）/班主任考核细则.doc"><img src="./icon_download.png"><br><br>班主任考核细则</a></td>
　                    </tr>
                      <tr align="center" height="120">
                        <td width="20%"><a href="./管理细则（6）/教学常规管理考评细则.WPS"><img src="./icon_download.png"><br><br>教学常规管理考评细则</a></td>
　                    </tr>
                    </table>
                </div>
            </div>
