...
public partial class SchoolMaster_SurveyList : System.Web.UI.Page
{
    ...
    private bool verifyValid()
    {
        ...
        {
            query = "insert into SurveyListUser (SurveyListSN, SurveyYear, SurveyStatus, SurveySchool) VALUES ('" +
                    Request["SN"].ToString() + "','" +
                    Request["YEAR"].ToString() + "','False' , N'" +
                    schoolName.ToString() + "')";
    ...
    {
        Response.Redirect("SurveyPreList.aspx");
    }
}