<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InternetStudy.aspx.cs" Inherits="SchoolMaster_InternetStudy" %>
        ...
        <div id="BlockRight">
            <div id="BlockRightUp">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:Label ID="Label1" runat="server" Text="自學教材" Font-Bold="true" ForeColor="Red"></asp:Label>
                </div>
            </div>
