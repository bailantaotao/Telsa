        ...
        <div id="BlockRight">
            ...
            <div id="BlockRightDown">
                <div id="BlockRightDownController">
                    <div>
                        <asp:TextBox ID="TbComment" runat="server" Width="680px" TextMode="MultiLine" Height="45px"></asp:TextBox>
                    </div>
                    <div style="float:left; padding:10px 0 0 30px">
                        <asp:Button ID="BtnComment" runat="server" Text="<%$ Resources:Resource, BtnSubmitComment %>" OnClick="Btn_Click" />
