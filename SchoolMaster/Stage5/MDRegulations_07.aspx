            ...
            <div id="BlockRightDown">
                <div id="BlockRightDownDataDisplay">
                    <table align="center" >
                        ...
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="提示:" Font-Size="16pt" ForeColor="Red"></asp:Label>
                        </td>
                        <tr>
                            <td>
                                <asp:Label ID="Label32" runat="server" Text="1.首次点选参考范例" Font-Size="14pt" ForeColor="Purple"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label33" runat="server" Text="2.编辑成本校规章制度另存新档" Font-Size="14pt" ForeColor="Purple"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label34" runat="server" Text="3.上传为本校规章制度" Font-Size="14pt" ForeColor="Purple"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label35" runat="server" Text="4.尔后更新下载本校规章制度修改" Font-Size="14pt" ForeColor="Purple"></asp:Label>
                            </td>
                        </tr>
                    </tr>
                    </table>
