<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QViewScoreList.aspx.cs" Inherits="SchoolMaster_QViewScoreList" %>
        ...
        <div id="BlockRight">
            <div id="BlockRightUp">
               <div style="background: url(../Image/zh-TW/TipGary_TipUserLocation.png) no-repeat; text-align:center; width: 175px; height:39px; float: left;  line-height:39px;">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="true" ForeColor="Red" Text="<%$ Resources:Resource, QStudentScore %>" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
