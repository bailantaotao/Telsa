<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InternetStudyQuestionnaire.aspx.cs" Inherits="SchoolMaster_InternetStudyQuestionnaire" %>
<%@ Register Src="UserControlQuestionAnswer.ascx" TagName="UCQA" TagPrefix="CustomControl" %>
<!DOCTYPE html>
        ...
        <div id="BlockRight">
            <div id="BlockRightUp">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyBtnStudy" runat="server" Font-Bold="true" ForeColor="Red" Text="<%$ Resources:Resource, TipTeachContentEdit %>" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"></asp:HyperLink>
                </div>
                <div style="text-align:center; width: 14px; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
