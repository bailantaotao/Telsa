<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuideViewSDPEvaluateResult.aspx.cs" Inherits="SchoolMaster_GuideViewSDPEvaluateResult" %>
                    ...
                    <table style="width: 735px">
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:Label ID="LbGuideViewResultTargetSchool" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 735px">
                        <tr>
                            <td class="style20">
                                <asp:HyperLink ID="HlGuideResultIndicator" runat="server" Text="‧学校发展计划的关注点及评估监测指标(说明)" NavigateUrl="~/SchoolMaster/GuideViewSDPIndicator.aspx"></asp:HyperLink>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 735px">
