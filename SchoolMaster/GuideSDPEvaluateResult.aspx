<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuideSDPEvaluateResult.aspx.cs" Inherits="SchoolMaster_GuideSDPEvaluateResult" %>
                ...
                <div id="BlockRightDownDataDisplay">
                    <table style="width: 735px">
                        <tr>
                            ...
                            <td align="left">
                                <asp:Label ID="GuideResultTargetSchool" runat="server" Text="学校:" ForeColor="Blue"></asp:Label>
                                <asp:Label ID="LbGuideResultTargetSchool" runat="server" Text=""></asp:Label>
                                &nbsp
                                </td>
                        </tr>
                    </table>
                    <table style="width: 735px">
                        <tr>
                            <td class="style20">
                                <asp:HyperLink ID="HlGuideResultIndicator" runat="server" Text="‧学校发展计划的关注点及评估监测指标(说明)" NavigateUrl="~/SchoolMaster/GuideSDPIndicator.aspx"></asp:HyperLink>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 735px">
                        ...
                        <tr>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore1" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >    
                                <asp:Label ID="LbProvinceScore1" runat="server" Text=""></asp:Label> 
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore2" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >                               
                               <asp:Label ID="LbProvinceScore2" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="1" rowspan="2" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style29" >
                                <asp:DropDownList ID="DlShlScore3" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style30" >                               
                                <asp:Label ID="LbProvinceScore3" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore4" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >                                
                                <asp:Label ID="LbProvinceScore4" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            class="style17" >
                                <asp:DropDownList ID="DlShlScore5" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            class="style18" >                                
                                <asp:Label ID="LbProvinceScore5" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                             <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                 class="style17" >
                                <asp:DropDownList ID="DlShlScore6" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                 class="style18" >                               
                                <asp:Label ID="LbProvinceScore6" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore7" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >                               
                                <asp:Label ID="LbProvinceScore7" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore8" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >                               
                                <asp:Label ID="LbProvinceScore8" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                             <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                 class="style17" >
                                <asp:DropDownList ID="DlShlScore9" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                 class="style18" >                               
                                <asp:Label ID="LbProvinceScore9" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                             <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                 class="style17" >
                                <asp:DropDownList ID="DlShlScore10" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                 class="style18" >                                
                                <asp:Label ID="LbProvinceScore10" runat="server" Text=""></asp:Label>
                        </tr>
                        <tr>
                            <td align="center" colspan="1" rowspan="2" style="border: thin Ridge black" 
                                class="style13" >
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore11" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >                                
                                <asp:Label ID="LbProvinceScore11" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style17" >
                                <asp:DropDownList ID="DlShlScore12" runat="server" Height="33px" Width="57px" 
                                    Font-Size="14pt">
                                    <asp:ListItem Selected="True">0</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                            ...
                            <td align="center" colspan="1" rowspan="1" style="border: thin Ridge black" 
                                class="style18" >                                
                                <asp:Label ID="LbProvinceScore12" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="3" rowspan="1" style="border: thin Ridge black">
                        ...
                        <tr>
                            <td align="right" colspan="8">
                                <asp:Button ID="BtnSave" runat="server" Text="储存" Height="22px" 
                                    ...
                                    &nbsp&nbsp&nbsp
                                <asp:Button ID="BtnCancel" runat="server" Text="取消" Height="22px" 
