...
public partial class SchoolMaster_SurveyListEnglish : System.Web.UI.Page
{
    ...
    private void setInitial()
    {
        ...
        string query1 = "select Proposal1, Proposal2 from SurveyListEnglish " +
                       "where SN ='" + Session["UserSurveyListSN"].ToString() + "'" +
                       "and Year='" + Session["SurveyYear"].ToString() + "'" +
                       "and School = N'" + schoolName.ToString() + "'";
    ...
    private void storeData()
    {
        ...
        query = "insert into SurveyListEnglish (SN, Year, School, ListYear, ListMonth, ListDay, Q1, Q2, Q3, Q4, Q5, Q6, Q7, Q8, Q9, Q10, Q11, SatisfyScore1, SatisfyScore2, SatisfyScore3, Proposal1, Proposal2, Complete) VALUES ('" +
