...
public partial class SchoolMaster_SurveyListMath : System.Web.UI.Page
{
    ...
    private void storeData()
    {
        ...
        ManageSQL ms = new ManageSQL();
        //先刪除原本的
        string query = "delete from SurveyListMath where SN ='" + Session["UserSurveyListSN"].ToString() + "'" + "and Year ='" + Session["SurveyYear"].ToString() + "'" + "and School= N'" + schoolName.ToString() + "'";
