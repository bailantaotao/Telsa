<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyViewListMath.aspx.cs" Inherits="SchoolMaster_SurveyViewListMath" %>
            ...
            <div id="BlockRightDown">
                ...
                <div id="BlockRightDownDataDisplay">
                    <table style="width: 735px">
                        <tr>
                            <td >
                                <asp:Label ID="Label7" runat="server" Text="明德小学教学精进项目(数学教材)使用意见调查表" Font-Size="Large" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr><td></td></tr>
                        <tr>
