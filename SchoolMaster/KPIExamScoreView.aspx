<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KPIExamScoreView.aspx.cs" Inherits="SchoolMaster_KPIExamScoreView" %>
                        ...
                        <tr>
                            <td align="left">
                                ...
                                <div style="text-align:left">
                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Resource, TipKpiList %>"></asp:Label>
                                </div>
                            </td>
                            <td align="right">
