<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyList.aspx.cs" Inherits="SchoolMaster_SurveyList" %>
                            ...
                            <td align="center" class="" >
                                ...
                                &nbsp&nbsp&nbsp<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#Eval("SurveyQuestionnaireURL")%>'  Text="填写"></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                    ...
                                    SelectCommand="SELECT [SurveyQuestionnaireID], [SurveyQuestionnaireName], [SurveyQuestionnaireURL] FROM [SurveyQuestionnaireName]">
                                </asp:SqlDataSource>
                            </td>
                        </tr>
                        <tr>
