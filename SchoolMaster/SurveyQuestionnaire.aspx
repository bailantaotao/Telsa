<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyQuestionnaire.aspx.cs" Inherits="SchoolMaster_SurveyQuestionnaire" %>
            ...
            <div id="BlockRightDown">
                ...
                <div id="BlockRightDownDataDisplay">
                    <table style="width: 735px">
                        ...
                        <tr>
                            <td >
                                <asp:Label ID="Label7" runat="server" Text="明德品牌建设工程--明德特色办学首期校长研修班后期调查问卷" Font-Size="18pt" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="style1">
                                <asp:TextBox ID="TbRequest" runat="server" Width="720px"  Height="100px" TextMode="MultiLine" Font-Size="14pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TbComment1" runat="server" Width="720px" Height="100px" TextMode="MultiLine" Font-Size="14pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TbComment2" runat="server" Width="720px" Height="100px" TextMode="MultiLine" Font-Size="14pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TbProposal" runat="server" Width="720px" Height="75px" TextMode="MultiLine" Font-Size="16pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
