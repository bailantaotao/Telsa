<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QViewStudentList.aspx.cs" Inherits="SchoolMaster_QViewScoreList" %>
                ...
                <div id="BlockRightDownController">
                    ...
                    <tr>
                        <td align="left">
                            <ul>
                                <li>
                            <asp:HyperLink ID="HyperLink4" runat="server" Font-Bold="true" ForeColor="Black" Text="学生基本信息编辑" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
                         NavigateUrl="QEditStudent.aspx"></asp:HyperLink>
                                </li>
                                 <li>
                            <asp:HyperLink ID="HyperLink5" runat="server" Font-Bold="true" ForeColor="Red" Text="学生基本信息观看" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
                         NavigateUrl="QViewStudentList.aspx"></asp:HyperLink>
                                </li>
                            </ul>
                        </td>
