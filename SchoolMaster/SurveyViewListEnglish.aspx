<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyViewListEnglish.aspx.cs" Inherits="SchoolMaster_SurveyViewListEnglish" %>
            ...
            <div id="BlockRightDown">
                ...
                <div id="BlockRightDownDataDisplay">
                    <table style="width: 735px">
                        <tr>
                            <td >
                                <asp:Label ID="Label7" runat="server" Text="明德小学教学精进项目(英语教材)使用意见调查表" Font-Size="Large" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr><td></td></tr>
                        <tr>
...
　                       </tr>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ1O1" runat="server" GroupName="RbQ1" Enabled="False"/>
                            ...
                            <td width="100">
                                <asp:RadioButton ID="RbQ1O4" runat="server" GroupName="RbQ1" Enabled="False"/>
                                <asp:Label ID="Label13" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ1O5" runat="server" GroupName="RbQ1" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ2O1" runat="server" GroupName="RbQ2" Enabled="False"/>
                                <asp:Label ID="Label16" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ2O2" runat="server" GroupName="RbQ2" Enabled="False"/>
                                <asp:Label ID="Label17" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ2O3" runat="server" GroupName="RbQ2" Enabled="False"/>
                                <asp:Label ID="Label18" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ2O4" runat="server" GroupName="RbQ2" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            ...
                            <td width="100">
                                <asp:RadioButton ID="RbQ3O2" runat="server" GroupName="RbQ3" Enabled="False"/>
                                <asp:Label ID="Label23" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ3O3" runat="server" GroupName="RbQ3" Enabled="False"/>
                                <asp:Label ID="Label24" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ3O4" runat="server" GroupName="RbQ3" Enabled="False"/>
                                <asp:Label ID="Label25" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ3O5" runat="server" GroupName="RbQ3" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ4O1" runat="server" GroupName="RbQ4" Enabled="False"/>
                                <asp:Label ID="Label28" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ4O2" runat="server" GroupName="RbQ4" Enabled="False"/>
                                <asp:Label ID="Label29" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ4O3" runat="server" GroupName="RbQ4" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ5O1" runat="server" GroupName="RbQ5" Enabled="False"/>
                                <asp:Label ID="Label34" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ5O2" runat="server" GroupName="RbQ5" Enabled="False"/>
                                <asp:Label ID="Label35" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ5O3" runat="server" GroupName="RbQ5" Enabled="False"/>
                                <asp:Label ID="Label36" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ5O4" runat="server" GroupName="RbQ5" Enabled="False"/>
...
　                       </tr>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ6O1" runat="server" GroupName="RbQ6" Enabled="False"/>
                                <asp:Label ID="Label41" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ6O2" runat="server" GroupName="RbQ6" Enabled="False"/>
                                <asp:Label ID="Label42" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ6O3" runat="server" GroupName="RbQ6" Enabled="False"/>
                                <asp:Label ID="Label43" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ6O4" runat="server" GroupName="RbQ6" Enabled="False"/>
                                <asp:Label ID="Label44" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ6O5" runat="server" GroupName="RbQ6" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ7O1" runat="server" GroupName="RbQ7" Enabled="False"/>
                                <asp:Label ID="Label47" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ7O2" runat="server" GroupName="RbQ7" Enabled="False"/>
                                <asp:Label ID="Label48" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ7O3" runat="server" GroupName="RbQ7" Enabled="False"/>
                                <asp:Label ID="Label49" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ7O4" runat="server" GroupName="RbQ7" Enabled="False"/>
                                <asp:Label ID="Label50" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ7O5" runat="server" GroupName="RbQ7" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ8O1" runat="server" GroupName="RbQ8" Enabled="False"/>
                                <asp:Label ID="Label53" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ8O2" runat="server" GroupName="RbQ8" Enabled="False"/>
                                <asp:Label ID="Label54" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ8O3" runat="server" GroupName="RbQ8" Enabled="False"/>
                                <asp:Label ID="Label55" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ8O4" runat="server" GroupName="RbQ8" Enabled="False"/>
                                <asp:Label ID="Label56" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ8O5" runat="server" GroupName="RbQ8" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ9O1" runat="server" GroupName="RbQ9" Enabled="False"/>
                                <asp:Label ID="Label59" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ9O2" runat="server" GroupName="RbQ9" Enabled="False"/>
                                <asp:Label ID="Label60" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ9O3" runat="server" GroupName="RbQ9" Enabled="False"/>
                                <asp:Label ID="Label61" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ9O4" runat="server" GroupName="RbQ9" Enabled="False"/>
                                <asp:Label ID="Label62" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ9O5" runat="server" GroupName="RbQ9" Enabled="False"/>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ10O1" runat="server" GroupName="RbQ10" Enabled="False"/>
                                <asp:Label ID="Label65" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ10O2" runat="server" GroupName="RbQ10" Enabled="False"/>
                                <asp:Label ID="Label66" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ10O3" runat="server" GroupName="RbQ10" Enabled="False"/>
                                <asp:Label ID="Label67" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ10O4" runat="server" GroupName="RbQ10" Enabled="False"/>
                                <asp:Label ID="Label68" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ10O5" runat="server" GroupName="RbQ10" Enabled="False"/>
...
　                       </tr>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td width="100">
                                <asp:RadioButton ID="RbQ11O1" runat="server" GroupName="RbQ11" Enabled="False"/>
                                <asp:Label ID="Label72" runat="server" Text="很满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ11O2" runat="server" GroupName="RbQ11" Enabled="False"/>
                                <asp:Label ID="Label73" runat="server" Text="满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ11O3" runat="server" GroupName="RbQ11" Enabled="False"/>
                                <asp:Label ID="Label74" runat="server" Text="基本满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ11O4" runat="server" GroupName="RbQ11" Enabled="False"/>
                                <asp:Label ID="Label75" runat="server" Text="不满意"></asp:Label>
                            </td>
                            <td width="100">
                                <asp:RadioButton ID="RbQ11O5" runat="server" GroupName="RbQ11" Enabled="False"/>
...
　                       </tr>
                    ...
                    <table width="720px">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TbWord" runat="server" Width="720px" Height="100px" 
                                    TextMode="MultiLine" Font-Size="14pt" Enabled="False"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
