<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuideActivityList.aspx.cs" Inherits="Expert_GuideActivityList" %>
...
<body style="margin: 0; padding: 0; font-size: 14pt; border-top-style: none; font-family: Arial; border-right-style: none; border-left-style: none; border-bottom-style: none; background:url(../<%= backgroundImage %>) no-repeat center top;" background="../Image/zh-CN/Background.png">
    ...
    <div align="center" style="width: 1024px; margin: 0px auto;">
        ...
        <div id="BlockRight">
                    ...
                    <table style="width: 735px">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="BtnAdd" runat="server" Text="新增活动纪录表" onclick="BtnAdd_Click"  />
                            </td>
                        </tr>
            ...
            BorderWidth="1px" CellPadding="3" CellSpacing="2" BorderColor="#DEBA84" Width="647px" style="margin-left: 0px"
                        >
...
<ItemStyle Width="120px" HorizontalAlign="Center" ></ItemStyle>
                           ...
                           <asp:TemplateField HeaderText="" ItemStyle-Width="50">
                                <ItemTemplate>
                                    <asp:Button ID="lbnView" runat="server" Text="编辑" OnClick="btn_View" 
                            ...
                            <asp:TemplateField HeaderText="" ItemStyle-Width="50">
                                <ItemTemplate>
                                    <asp:Button ID="lbnDelete" runat="server" Text="<%$ Resources:Resource, TipPlanDelete %>" OnClick="btn_Delete" 
                                        CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"  Width="50px" OnClientClick="return confirm('确定要删除吗？')"></asp:Button>
                                </ItemTemplate>
