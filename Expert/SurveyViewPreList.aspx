<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyViewPreList.aspx.cs" Inherits="Expert_SurveyViewPreList" %>
                    ...
                    <table width="739px">
                        ...
                        <tr>
                            <td align="left" colspan="4" width="600px">
                                <asp:Label ID="LbTipProvince" runat="server" Text="<%$ Resources:Resource, TipProvince %>" ForeColor="Blue"></asp:Label>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="DdlStatus" runat="server" Width="80px" Font-Size="14pt">
                                            ...
                                            <asp:ListItem Value="True" Text="已完成"></asp:ListItem>
                                            <asp:ListItem Value="False" Text="未完成"></asp:ListItem>
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="BtnSearch" EventName="Click" />
