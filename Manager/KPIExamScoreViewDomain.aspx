<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KPIExamScoreViewDomain.aspx.cs" Inherits="SchoolMaster_KPIExamScoreViewDomain" %>
                   ...
                   <table style="width: 735px">
                       ...
                       <tr>
                            <td align="left" colspan="2">                                
                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:Resource, TipKPIDimension %>"></asp:Label>                                
                                <asp:Label ID="LbDimension" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
