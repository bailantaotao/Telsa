...
public partial class Manager_GuideViewList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!verifyValid())
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Alert", "alert('" + Resources.Resource.TipPlanErrorData + "');window.location='GuideViewPreList.aspx';", true);
            return;
        }
        getSchoolName(schoolName);
