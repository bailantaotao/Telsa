...
public partial class SchoolMaster_PlanViewItem7 : System.Web.UI.Page
{
    ...
    protected void btn_View(object sender, EventArgs e)
    {
        ...
        if (sender is Button)
        {
            try
            {
                ...
                Response.Redirect("PlanViewItem7Sub.aspx?DepartmentNO=" + (Convert.ToInt32(yourAssignedValue) + 1));                
            }
            catch
            {
                //Check for exception
