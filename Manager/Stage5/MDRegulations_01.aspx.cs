...
public partial class Stage5_MDRegulations_01 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ArrayList dataImportYear = new ArrayList();
        ...
        if (DlProvince.SelectedValue.ToString() != Resources.Resource.DdlTypeProvince.ToString())
        {
            if (ProvinceState.ToString() != DlProvince.SelectedValue.ToString())
            {
                ...
                {
                    ProvinceQuery = "select ID from Area " +
                                    "where Name = N'" + DlProvince.SelectedValue.ToString() + "' ";
    ...
    private bool getUploadDir(int targetIndex, StringBuilder sb, StringBuilder outFile)
    {
        ...
        string fileName = TargetSchool + "1" + targetIndex;   //目前刪除getSemester()函示不做學期的判斷
