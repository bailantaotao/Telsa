...
public partial class Manager_GuideAdd : System.Web.UI.Page
{
        ...
        if (sender is Button)
        {
            try
            {
...

                {
                    ...
                    string query = "delete from GuideList where GuideYear = '" + dt.Rows[Convert.ToInt32(yourAssignedValue)][1] + "' and GuideSemester = '" + dt.Rows[Convert.ToInt32(yourAssignedValue)][2] + "'";
                    ...
                    Response.Redirect("GuideAdd.aspx");
                }
    ...
    private void setInitial()
    {
        ...
        string query = "select GuideYear, GuideSemester " +
                       "from GuideList order by GuideYear desc, GuideSemester asc";
    ...
    {
        string query = "select count(*) from GuideList where GuideYear='" + TbYear.Text.Trim() + "' and GuideSemester = '" + TbSemester.Text.Trim() + "'";
        StringBuilder sb = new StringBuilder();
        ManageSQL ms = new ManageSQL();
    ...
    private void storeData()
    {
        if (ViewState["dt"] != null)
        {
            ...
            query = "insert into GuideList (GuideYear, GuideSemester) VALUES ('" +
                            TbYear.Text.Trim() + "','" +
