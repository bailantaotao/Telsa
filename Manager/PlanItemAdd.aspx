<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanItemAdd.aspx.cs" Inherits="Manager_PlanItemAdd" %>
        ...
        <div id="BlockRight">
            <div id="BlockRightUp">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="true" ForeColor="Black" Text="<%$ Resources:Resource, TipPlanDataView %>" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
