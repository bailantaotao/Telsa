<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KPIExamScoreViewDimension.aspx.cs" Inherits="SchoolMaster_KPIExamScoreViewDimension" %>
            ...
            <div id="BlockRightUp">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="true" ForeColor="Black" Text="<%$ Resources:Resource, TipPlanDataAdd %>" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
                         NavigateUrl="KPIAdd.aspx"></asp:HyperLink>
                </div>
            </div>
                   ...
                   <table style="width: 735px">
                       ...
                       <tr>
                            <td align="left" colspan="2">                                
                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:Resource, TipKPIRealScore %>"></asp:Label>                                
                                <asp:Label ID="LbRealScore" runat="server" Text=""></asp:Label>                                  
                            </td>
                        </tr>
                       <tr>
                            <td align="left" colspan="2">                                
                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Resource, TipKPISchoolScoreLevel %>"></asp:Label>                                
