...
public partial class Manager_SurveyAdd : System.Web.UI.Page
{
        ...
        if (sender is Button)
        {
            try
            {
...

                {
                    ...
                    string query = "delete from SurveyList where SurveyYear = '" + dt.Rows[Convert.ToInt32(yourAssignedValue)][1] + "'";
                    ...
                    Response.Redirect("SurveyAdd.aspx");
                    //ViewState["dt"] = dt;
    ...
    private void setInitial()
    {
        ...
        string query = "select SurveyYear, Deadline " +
                       "from SurveyList order by SurveyYear desc";
    ...
    {
        string query = "select count(*) from SurveyList where SurveyYear='" + TbYear.Text.Trim() + "'";
        StringBuilder sb = new StringBuilder();
        ManageSQL ms = new ManageSQL();
    ...
    private void storeData()
    {
        if (ViewState["dt"] != null)
        {
            ...
            query = "insert into SurveyList (SurveyYear, Deadline) VALUES ('" +
                            TbYear.Text.Trim() + "','" +
