...
<table width="739px" align="left" runat="server" style="border: groove 5px">
    ...
    <tr>
        <td colspan="4" style="padding: 5px; height: auto;">
            <asp:TextBox ID="TbQuestion" runat="server" Width="695px" TextMode="MultiLine" Height="50px" style="resize:none;"></asp:TextBox>
        </td>
    </tr>
    <tr>
