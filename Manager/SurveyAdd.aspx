<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyAdd.aspx.cs" Inherits="Manager_SurveyAdd" %>
    ...
    <div align="center" style="width: 1024px; margin: 0px auto;">
        ...
        <div id="BlockRight">
            <div id="BlockRightUp">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="true" ForeColor="Red" Text="新学年输入" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
                ...
                <div id="BlockRightDownDataDisplay">
                    <table style="width: 735px">
                        ...
                        BorderWidth="1px" CellPadding="5" CellSpacing="1">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="Deadline" HeaderText="提交有效期限" ItemStyle-Width="70px" />
                                    </Columns>
                                    <Columns>
