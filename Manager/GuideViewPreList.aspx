<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuideViewPreList.aspx.cs" Inherits="Manager_GuideViewPreList" %>
        ...
        <div id="BlockRight">
            <div id="BlockRightUp">
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="true" ForeColor="Red" Text="执行/监测报告观看" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
                ...
                <div style="text-align:center; width: auto; height:39px; float: left;  line-height:39px; vertical-align:middle; padding-left:15px;">
                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="true" ForeColor="Black" Text="学年新增" Font-Size="<%$ Resources:Resource, TextSizeTitle %>"
